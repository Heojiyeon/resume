...
const HeaderIntroduces = [
  {
    _id: 0,
    subheading: '개발에 정확한 근거를 제시할 수 있도록 노력합니다.',
    description:
      '하나의 컴포넌트는 목적성이 뚜렷한 하나의 기능을 가져야 한다는 신념을 가지고 그에 걸맞게 개발하고자 노력합니다. 프로젝트 상 도입해야 하는 새로운 기술에 대해 두려움 없이 빠르게 습득하며 항상 호기심을 가지고 배우려는 자세를 유지합니다. 공식 문서를 읽거나 동료들과 주기적으로 스터디를 진행하며 기술의 본질을 깨닫고 적재적소에 사용하기 위해 노력합니다.',
  },
  {
    _id: 1,
    subheading:
